...
app.get("/classic-seo-banner", async (req, res) => {
  try {
    let {
      articleName,
      author,
...
app.get('/seo-banner', async (req, res) => {
  const {
    title = "Untitle",
    author = "darkterminal",
  ...
  // ctx.drawImage(logoImage, 1000, 660, logoImage.width / 2 - 65, logoImage.height / 2 - 65)
